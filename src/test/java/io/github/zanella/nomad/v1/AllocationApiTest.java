...
import static io.github.zanella.nomad.v1.NodeApiTest.createNodeallocation;
import static org.junit.Assert.assertEquals;

public class AllocationApiTest extends AbstractCommon {
    @Test
    public void getAllocationTest() {
        final String rawAllocation = "{" +
        ...
        stubFor(get(urlEqualTo(AllocationApi.allocationUrl + "/42"))
                        .willReturn(aResponse().withHeader("Content-Type", "application/json").withBody(rawAllocation)));

        assertEquals(createNodeallocation(), nomadClient.v1.allocation.getAllocation("42"));
    }
}
